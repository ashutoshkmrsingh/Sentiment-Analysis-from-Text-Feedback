...
class Db:
    ...
    # creating field before insert
        self.myfield = { "Domain": mobile.lower(), "Review": self.review, "Polarity":self.polarity}
    ...
    def Insert_Aspect(self, d):
        # take input dict as ver. temp
        for _ in d.keys():
            self.myfield = { "Aspect": _, "Polarity":d[_]}
            x = self.mycol.insert_one(self.myfield)

    def Display_Aspect(self, aspect):
